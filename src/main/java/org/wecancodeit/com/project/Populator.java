...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Ocean indian = new Ocean("Indian Ocean","/images/ocean.png");
        oceanRepo.save(indian);
        Ocean atlantic = new Ocean("Atlantic Ocean","/images/ocean.png");
        oceanRepo.save(atlantic);
        Ocean pacific = new Ocean("Pacific Ocean","/images/ocean.png");
        oceanRepo.save(pacific);
        Ocean arctic = new Ocean("Arctic Ocean","/images/ocean.png");
        ...
        Island greatBritain = new Island("greatBritain", unitedKingdom, europe, britishIsles,"/images/GreatBritainIsland.png");
        islandRepo.save(greatBritain);
        Island ireland = new Island("ireland", unitedKingdom, europe, britishIsles,"/images/IrelandIsland.png");
        islandRepo.save(ireland);
        Island isleOfMan = new Island("isleOfMan", unitedKingdom , europe, britishIsles,"/images/IsleOfManIsland.png");
