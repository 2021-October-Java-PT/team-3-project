...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Country austrailia = new Country("austrailia", oceania,  "image");
        ...
        Country unitedKingdom  = new Country("unitedKingdom", europe, "image");
        ...
        IslandCluster austrailianIslands = new IslandCluster("austrailianIslands", austrailia, oceania, "image");
        ...
        IslandCluster britishIsles = new IslandCluster("britishIsles", unitedKingdom, europe , "image",atlantic);
        ...
        Island kagarooIsland =new Island("Kagaroo Island", austrailia, oceania, austrailianIslands,"image");
        islandRepo.save(kagarooIsland);
        Island brunyIsland =new Island("Bruny Island", austrailia, oceania, austrailianIslands,"image");
        islandRepo.save(brunyIsland);
        Island findersIsland =new Island("Finders Island", austrailia, oceania, austrailianIslands,"image");
        ...
        Island santiagoIsland = new Island("santiagoIsland",ecuador , southAmerica, galapagosIslands,"image");
